...
namespace MathimaticsConsole
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            {
                case "add":
                    Console.WriteLine($"{_num1} + {_num2} = {math.AddNumbers(_num1, _num2)}"); break;
                case "sub":
                    Console.WriteLine($"{_num1} - {_num2} = {math.SubNumbers(_num1, _num2)}"); break;
                case "mul":
                    Console.WriteLine($"{_num1} * {_num2} = {math.MulNumbers(_num1, _num2)}"); break;
                case "div":
                    Console.WriteLine($"{_num1} / {_num2} = {math.DivNumbers(_num1, _num2)}"); break;
                default: Console.WriteLine($"{_operand} is not a valid operator. Please enter Add, Sub, Mul or Div"); break;
